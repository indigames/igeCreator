...
void PhysicObjectEditorComponent::drawPhysicObject()
{
    ...
    auto physicComp = getComponent<PhysicObject>();
...
void PhysicObjectEditorComponent::drawPhysicConstraints()
{
    ...
    createCompButton->getOnClickEvent().addListener([this](auto widget) {
        ...
        case (int)PhysicConstraint::ConstraintType::Fixed:
            getComponent<PhysicObject>()->addConstraint<FixedConstraint>();
            break;
        case (int)PhysicConstraint::ConstraintType::Hinge:
            getComponent<PhysicObject>()->addConstraint<HingeConstraint>();
            break;
        case (int)PhysicConstraint::ConstraintType::Slider:
            getComponent<PhysicObject>()->addConstraint<SliderConstraint>();
            break;
        case (int)PhysicConstraint::ConstraintType::Spring:
            getComponent<PhysicObject>()->addConstraint<SpringConstraint>();
            break;
        case (int)PhysicConstraint::ConstraintType::Dof6Spring:
            getComponent<PhysicObject>()->addConstraint<Dof6SpringConstraint>();
            break;
        }
        dirty();
        });
    ...
    const auto& constraints = getComponent<PhysicObject>()->getContraints();
...
void PhysicObjectEditorComponent::drawFixedConstraint(std::shared_ptr<PhysicConstraint> constraint)
{
    ...
    constraintGroup->getOnClosedEvent().addListener([&, this]() {
        getComponent<PhysicObject>()->removeConstraint(constraint);
        dirty();
        });
