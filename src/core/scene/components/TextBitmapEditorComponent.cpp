...
TextBitmapEditorComponent::TextBitmapEditorComponent() {
...
void TextBitmapEditorComponent::onInspectorUpdate()
{   
    drawComponent();
}

void TextBitmapEditorComponent::drawComponent()
{
    if (m_textCompGroup == nullptr) {
        m_textCompGroup = m_group->createWidget<Group>("TextBitmapGroup", false);
    }
