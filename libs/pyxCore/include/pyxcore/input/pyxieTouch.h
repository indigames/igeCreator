...
namespace pyxie
{
    ...
    public:
        ...
        TouchEvent(EventCode eventCode, const std::shared_ptr<Finger>& finger);
        virtual ~TouchEvent();

        EventCode getEventCode() const;
        const std::shared_ptr<Finger>& getFinger() const;
    ...
    public:
        ...
        void setOnTouchBeganCallback(std::function<void(const std::shared_ptr<Event>& event)> fn);
        void setOnTouchEndedCallback(std::function<void(const std::shared_ptr<Event>& event)> fn);
        void setOnTouchMovedCallback(std::function<void(const std::shared_ptr<Event>& event)> fn);
        void setOnTouchScrolledCallback(std::function<void(const std::shared_ptr<Event>& event)> fn);

    protected:
        std::function<void(const std::shared_ptr<Event>& event)> onTouchBegan;
        std::function<void(const std::shared_ptr<Event>& event)> onTouchEnded;
        std::function<void(const std::shared_ptr<Event>& event)> onTouchMoved;
        std::function<void(const std::shared_ptr<Event>& event)> onTouchScrolled;
    ...
    public:
        ...
        std::shared_ptr<Finger> getFinger(int idx);
        ...
        int getFingersCount();
        const std::vector<std::shared_ptr<Finger>>& getAllFingers() const;
