...
namespace pyxie
{
    ...
    public:
        ...
        virtual bool init();
        void setCallback(const std::function<void(const std::shared_ptr<Event>&)>& callback);
    ...
    protected:
        Type _type;
        std::string _id;
        std::function<void(const std::shared_ptr<Event>&)> _onEvent;
        Priority _priority;
    ...
    public:
        ...
        void addEventListener(const std::shared_ptr<EventListener>& listener, EventListener::Priority prio);
    ...
    protected:
        std::string getEventListenerID(const std::shared_ptr<Event>& event) const;
        void sortEventListeners(const std::string& listenerID);
        void setPriorityDirty(const std::string& listenerID, bool isPriorityDirty);
