...
private:
	...
	bool hasStartTime, hasEndTime, hasFPS;
	...
	DeclareParameter(float, FUParameterQualifiers::SIMPLE, fps, FC("FPS"));
...
public:
	...
	inline bool HasFPS() const { return hasFPS; }
	inline float GetFPS() const { return fps; }
	inline void SetFPS(float time) { fps = time; hasFPS = true; }
