...
private:
	...
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_backbuffer,		FC("enable_backbuffer"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_shadow,			FC("enable_shadow"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_manipulator,		FC("enable_manipulator"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_aspect,			FC("enable_aspect"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, aspect_ratio,				FC("aspect_ratio"));
	DeclareParameter(FMVector3, FUParameterQualifiers::SIMPLE, bg_color,			FC("bg_color"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_post_effect,		FC("enable_post_effect"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_color_correction,	FC("enable_color_correction"));
	DeclareParameter(bool, FUParameterQualifiers::SIMPLE, enable_glare,				FC("enable_glare"));
	DeclareParameter(float, FUParameterQualifiers::SIMPLE, blur_offset,				FC("blur_offset"));
	DeclareParameter(float, FUParameterQualifiers::SIMPLE, bloom_scale,				FC("bloom_scale"));
	DeclareParameter(float, FUParameterQualifiers::SIMPLE, bloom_limit,				FC("bloom_limit"));

	DeclareParameter(FMVector3List, FUParameterQualifiers::SIMPLE, rgb_channel,		FC("rgb_channel"));
	DeclareParameter(FMVector3List, FUParameterQualifiers::SIMPLE, r_channel,		FC("r_channel"));
	DeclareParameter(FMVector3List, FUParameterQualifiers::SIMPLE, g_channel,		FC("g_channel"));
	DeclareParameter(FMVector3List, FUParameterQualifiers::SIMPLE, b_channel,		FC("b_channel"));
...
public:
	...
	inline bool GetEnableBackbuffer() const { return enable_backbuffer; }
	inline void SetEnableBackbuffer(bool _enable_backbuffer) { enable_backbuffer = _enable_backbuffer; SetDirtyFlag(); }

	inline bool GetEnableShadow() const { return enable_shadow; }
	inline void SetEnableShadow(bool _enable_shadow) { enable_shadow = _enable_shadow; SetDirtyFlag(); }

	inline bool GetEnableManipulator() const { return enable_manipulator; }
	inline void SetEnableManipulator(bool _enable_manipulator) { enable_manipulator = _enable_manipulator; SetDirtyFlag(); }

	inline bool GetEnableAspect() const { return enable_aspect; }
	inline void SetEnableAspect(bool _enable_aspect) { enable_aspect = _enable_aspect; SetDirtyFlag(); }

	inline const FMVector3& GetBGColor() const { return bg_color; }
	inline void SetBGColor(const FMVector3& _bg_color) { bg_color = _bg_color; SetDirtyFlag(); }

	inline bool GetEnablePostEffect() const { return enable_post_effect; }
	inline void SetEnablePostEffect(bool _enable_post_effect) { enable_post_effect = _enable_post_effect; SetDirtyFlag(); }

	inline bool GetEnableColorCorrection() const { return enable_color_correction; }
	inline void SetEnableColorCorrection(bool _enable_color_correction) { enable_color_correction = _enable_color_correction; SetDirtyFlag(); }

	inline bool GetEnableGlare() const { return enable_glare; }
	inline void SetEnableGlare(bool _enable_glare) { enable_glare = _enable_glare; SetDirtyFlag(); }

	inline float GetBlurOffset() const { return blur_offset; }
	inline void SetBlurOffset(float _blur_offset) { blur_offset = _blur_offset; SetDirtyFlag(); }

	inline float GetBloomScale() const { return bloom_scale; }
	inline void SetBloomScale(float _bloom_scale) { bloom_scale = _bloom_scale; SetDirtyFlag(); }

	inline float GetBloomLimit() const { return bloom_limit; }
	inline void SetBloomLimit(float _bloom_limit) { bloom_limit = _bloom_limit; SetDirtyFlag(); }

	inline const FMVector3List& GetRGBChannel() const { return rgb_channel; }
	inline void SetRGBChannel(const FMVector3List& _rgb_channel) { rgb_channel = _rgb_channel; SetDirtyFlag(); }

	inline const FMVector3List& GetRChannel() const { return r_channel; }
	inline void SetRChannel(const FMVector3List& _r_channel) { r_channel = _r_channel; SetDirtyFlag(); }

	inline const FMVector3List& GetGChannel() const { return g_channel; }
	inline void SetGChannel(const FMVector3List& _g_channel) { g_channel = _g_channel; SetDirtyFlag(); }

	inline const FMVector3List& GetBChannel() const { return b_channel; }
	inline void SetBChannel(const FMVector3List& _b_channel) { b_channel = _b_channel; SetDirtyFlag(); }
};
