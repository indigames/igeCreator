...
private:
	...
	DeclareParameterAnimatable(float, FUParameterQualifiers::SIMPLE, collisions, FC("IsCollisions"));
...
public:
	...
	bool IsDynamic() const{ return dynamic >= 0.5f; } /**< See above. */
	...
	FCDParameterAnimatableFloat& GetCollisions() { return collisions; }
	const FCDParameterAnimatableFloat& GetCollisions() const { return collisions; } /**< See above. */
	bool IsCollisions() const{ return collisions >= 0.5f; } /**< See above. */


	/** Sets whether the owner has collision response.
		@param collisions True if collisions. */
