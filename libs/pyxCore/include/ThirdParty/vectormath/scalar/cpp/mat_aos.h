...
#if defined(__APPLE_CC__)&&defined(__arm__)
#include <arm_neon.h>
#endif
...
inline bool Matrix3::operator ==(const Matrix3 & mat)
{
	return mCol0 == mat.mCol0 && mCol1 == mat.mCol1 && mCol2 == mat.mCol2;
}
inline bool Matrix3::operator !=(const Matrix3 & mat)
{
	return mCol0 != mat.mCol0 || mCol1 != mat.mCol1 || mCol2 != mat.mCol2;
...
inline bool Matrix4::operator ==(const Matrix4 & mat)
{
	return mCol0 == mat.mCol0 && mCol1 == mat.mCol1 && mCol2 == mat.mCol2 && mCol3 == mat.mCol3;
}
inline bool Matrix4::operator !=(const Matrix4 & mat)
{
	return mCol0 != mat.mCol0 || mCol1 != mat.mCol1 || mCol2 != mat.mCol2 || mCol3 != mat.mCol3;
...
{
#if defined(__APPLE_CC__)&&defined(__arm__)
    float32x4_t c0=vld1q_f32((float32_t*)&mCol0);
    float32x4_t c1=vld1q_f32((float32_t*)&mCol1);
    float32x4_t c2=vld1q_f32((float32_t*)&mCol2);
    float32x4_t c3=vld1q_f32((float32_t*)&mCol3);
    float32x4_t o=vmulq_n_f32(c0,(float32_t)vec.getX());
    o=vmlaq_n_f32(o,c1,(float32_t)vec.getY());
    o=vmlaq_n_f32(o,c2,(float32_t)vec.getZ());
    o=vmlaq_n_f32(o,c3,(float32_t)vec.getW());
    Vector4 v;
    vst1q_f32((float32_t*)&v,o);
    return v;
#else
    return Vector4(
...
inline bool Transform3::operator ==(const Transform3 & tfrm)
{
	return mCol0 == tfrm.mCol0 && mCol1 == tfrm.mCol1 && mCol2 == tfrm.mCol2 && mCol3 == tfrm.mCol3;
}
inline bool Transform3::operator !=(const Transform3 & tfrm)
{
	return mCol0 != tfrm.mCol0 || mCol1 != tfrm.mCol1 || mCol2 != tfrm.mCol2 || mCol3 != tfrm.mCol3;
